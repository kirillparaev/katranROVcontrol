...
"font: 9pt \"Cambria\";")
        ...
        self.frameAppTabs = QtWidgets.QFrame(parent=self.frame_title)
        ...
        self.btnCameraTab = QtWidgets.QPushButton(parent=self.frameAppTabs)
...
"")
        ...
        self.btnDebugTab = QtWidgets.QPushButton(parent=self.frameAppTabs)
...
"background-color: none;")
        ...
        self.dashboard = QtWidgets.QStackedWidget(parent=self.content_bar_and_styleSheet)
        self.dashboard.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        ...
        self.frame_10 = QtWidgets.QFrame(parent=self.page_Camera)
        ...
        self.labelSendingPacket_2 = QtWidgets.QLabel(parent=self.frame_14)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.FeedLabel = QtWidgets.QLabel(parent=self.frame_10)
        ...
        self.frame = QtWidgets.QFrame(parent=self.page_Debug)
        ...
        self.labelButtonsPressed = QtWidgets.QLabel(parent=self.frame_4)
        ...
        self.checkBox_Y_btn = QtWidgets.QCheckBox(parent=self.frame_7)
        ...
        self.checkBox_A_btn = QtWidgets.QCheckBox(parent=self.frame_7)
        ...
        self.checkBox_LB_btn = QtWidgets.QCheckBox(parent=self.frame_7)
        ...
        self.label_LT_L2 = QtWidgets.QLabel(parent=self.frame_7)
        self.label_LT_L2.setObjectName("label_LT_L2")
        self.horizontalLayout_6.addWidget(self.label_LT_L2)
        self.horizontalSlider_LT = QtWidgets.QSlider(parent=self.frame_7)
        ...
        self.checkBox_X_btn = QtWidgets.QCheckBox(parent=self.frame_8)
        ...
        self.checkBox_B_btn = QtWidgets.QCheckBox(parent=self.frame_8)
        ...
        self.checkBox_RB_btn = QtWidgets.QCheckBox(parent=self.frame_8)
        ...
        self.label_RT_R2 = QtWidgets.QLabel(parent=self.frame_8)
        self.label_RT_R2.setObjectName("label_RT_R2")
        self.horizontalLayout_7.addWidget(self.label_RT_R2)
        self.horizontalSlider_RT = QtWidgets.QSlider(parent=self.frame_8)
        self.horizontalSlider_RT.setEnabled(False)
        self.horizontalSlider_RT.setStyleSheet("")
        ...
        self.frame_2 = QtWidgets.QFrame(parent=self.page_Debug)
        ...
        self.labelSendingPacket = QtWidgets.QLabel(parent=self.frame_9)
        font = QtGui.QFont()
...
"font: 9pt \"MS Shell Dlg 2\";")
        ...
        self.frame_3 = QtWidgets.QFrame(parent=self.page_Debug)
        ...
        self.frame_16.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        ...
        self.frame_11 = QtWidgets.QFrame(parent=self.frame_16)
        self.frame_11.setMinimumSize(QtCore.QSize(600, 85))
        self.frame_11.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        ...
        spacerItem16 = QtWidgets.QSpacerItem(236, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem16, 0, 0, 1, 1)
        self.packet_emp1 = QtWidgets.QLabel(parent=self.frame_11)
        self.packet_emp1.setObjectName("packet_emp1")
        self.gridLayout.addWidget(self.packet_emp1, 1, 6, 1, 1)
        spacerItem17 = QtWidgets.QSpacerItem(255, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem17, 1, 0, 1, 2)
        self.packet_y = QtWidgets.QLabel(parent=self.frame_11)
        self.packet_y.setObjectName("packet_y")
        self.gridLayout.addWidget(self.packet_y, 1, 3, 1, 1)
        self.packet_x = QtWidgets.QLabel(parent=self.frame_11)
        self.packet_x.setObjectName("packet_x")
        self.gridLayout.addWidget(self.packet_x, 1, 2, 1, 1)
        self.packet_emp2 = QtWidgets.QLabel(parent=self.frame_11)
        self.packet_emp2.setObjectName("packet_emp2")
        self.gridLayout.addWidget(self.packet_emp2, 1, 7, 1, 1)
        spacerItem18 = QtWidgets.QSpacerItem(248, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem18, 0, 8, 1, 1)
        self.packet_z = QtWidgets.QLabel(parent=self.frame_11)
        self.packet_z.setObjectName("packet_z")
        self.gridLayout.addWidget(self.packet_z, 1, 4, 1, 1)
        spacerItem19 = QtWidgets.QSpacerItem(248, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem19, 1, 8, 1, 1)
        self.received_packet = QtWidgets.QLabel(parent=self.frame_11)
        self.received_packet.setObjectName("received_packet")
        self.gridLayout.addWidget(self.received_packet, 0, 1, 1, 7)
        self.packet_depth = QtWidgets.QLabel(parent=self.frame_11)
        self.packet_depth.setObjectName("packet_depth")
        self.gridLayout.addWidget(self.packet_depth, 1, 5, 1, 1)
        ...
        self.label_padNotDetected = QtWidgets.QLabel(parent=self.frame_18)
        ...
        self.label_padNotDetected.setStyleSheet("font: 10pt \"Cambria\";")
        self.label_padNotDetected.setObjectName("label_padNotDetected")
        self.horizontalLayout_16.addWidget(self.label_padNotDetected)
        self.label_connectionNotDetected = QtWidgets.QLabel(parent=self.frame_18)
        self.label_connectionNotDetected.setObjectName("label_connectionNotDetected")
        self.horizontalLayout_16.addWidget(self.label_connectionNotDetected)
        self.verticalLayout_7.addWidget(self.frame_18)
        self.frame_17 = QtWidgets.QFrame(parent=self.frame_3)
        self.frame_17.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        ...
        spacerItem20 = QtWidgets.QSpacerItem(318, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.label.setPixmap(QtGui.QPixmap(":/icons/icons/Robo.png"))
        self.label.setScaledContents(False)
        self.label.setObjectName("label")
        self.horizontalLayout_15.addWidget(self.label)
        spacerItem21 = QtWidgets.QSpacerItem(298, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.packet_emp1.setText(_translate("MainWindow", "00"))
        self.packet_y.setText(_translate("MainWindow", "00"))
        self.packet_x.setText(_translate("MainWindow", "00"))
        self.packet_emp2.setText(_translate("MainWindow", "00"))
        self.packet_z.setText(_translate("MainWindow", "00"))
        self.received_packet.setText(_translate("MainWindow", "   Принимаемый пакет"))
        self.packet_depth.setText(_translate("MainWindow", "00"))
        self.label_padNotDetected.setText(_translate("MainWindow", "Геймпад не обнаружен"))
        self.label_connectionNotDetected.setText(_translate("MainWindow", "Нет соединения с аппаратом"))
